...
import shoppingRelatedPageData from '../ShoppingRelated/shoppingRelatedPage.json'
...
const showCategoriesList = [1, 2, 3, 4, 20]

const Footer = () => {
    return (
        <footer className="bg-black text-white" aria-labelledby="footerHeading">
            ...
            <div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:py-16 lg:px-8">
                    ...
                    <div className="mt-12 grid grid-cols-1 gap-8 xl:mt-0 xl:col-span-2">
                        <div className="md:grid md:grid-cols-3 md:gap-8">
                            <div className=''>
                                ...
                                <div className="mt-4 space-y-4">
                                    <ul className="mt-4 space-y-4">
                                        {footerData.companyInformation.map((item) => (
                            ...
                            <div className="mt-12 md:mt-0">
                                ...
                                <ul className="mt-4 space-y-4">
                                    {categoriesData.categories.map((category) => {
                                        if (showCategoriesList.includes(category.cats_sid)) {
                                            return (<li key={category.cats_sid}>
                                                <Link
                                                    to={`/shop/${category.cats_sid}`}
                            ...
                            <div className="mt-12 md:mt-0">
                                ...
                                <ul className="mt-4 space-y-4">
                                    {shoppingRelatedPageData.menuList.map((shoppingRelated) => (
                                        <li key={shoppingRelated.intl_name}>
                                            <Link
                                                to={`${shoppingRelated.to}`}
                                                className="text-base text-gray-300 hover:text-white"
                                            >
                                                <FormattedMessage
                                                    id={`shoppingProcess.list.shoppingRelated.${shoppingRelated.intl_name}`}
                                                    defaultMessage={shoppingRelated.nav}
                                                />
                                            </Link>
                                        </li>
                                    ))}
                ...
                <div className="mt-12 border-t border-gray-200 pt-8">
                    <p className="text-base text-gray-400 xl:text-center">Copyright &copy; 2022 ZHEN All rights reserved.</p>
                </div>
            </div>
        </footer>
    )
